...
That original Reactior edition is today known colloquially as "Reactor Classic", as it uses a "[Reactor.lua](https://gitlab.com/WeSuckLess/Reactor/-/blob/master/System/Reactor.lua?ref_type=heads)" file and the BMD “UI Manager” API that both require “advanced” LuaJIT scripting capabilities to exist in the host Resolve Studio / Fusion Studio DCC application... 
